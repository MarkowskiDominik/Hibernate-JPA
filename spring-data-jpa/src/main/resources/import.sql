...
insert into book (id, title, library_id) values (1, 'Pierwsza książka', 0);
insert into book (id, title, library_id) values (2, 'Druga książka', 0);
insert into book (id, title, library_id) values (3, 'Trzecia książka', 0);
