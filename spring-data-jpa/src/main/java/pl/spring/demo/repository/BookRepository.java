...
public interface BookRepository extends
			...
			BookRepositoryQueryDsl,
			BookRepositoryJinq {

	@Query("select book from BookEntity book where upper(book.title) like concat(upper(:title), '%')")
	public List<BookEntity> findBooksByTitle(@Param("title") String title);
	...
	public List<BookEntity> findBooksByAuthor(@Param("author") String author);
}
